...
type CreateChannelRequest struct {
	// ID is generated by the authenticated API layer before secret-bearing
	// config is encrypted. It is never accepted from JSON and lets encryption
	// bind ciphertext to the final channel row before the first database write.
	ID      string         `json:"-"`
	Name    string         `json:"name"`
	Type    string         `json:"type"`
	Config  map[string]any `json:"config,omitempty"`
